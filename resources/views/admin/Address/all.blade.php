                    ...
                    <div class="card" bis_skin_checked="1">
                        <div class="card-body" bis_skin_checked="1">
                            <div style="display: flex; justify-content: space-between">
                                ...
                                <div>
                                    <a href="{{route('create_address_page')}}" class="btn btn-inverse-warning btn-fw">Добавить</a>
                                </div>
                            </div>
                                ...
                                <table id="myTable" class="display">
                                    ...
                                    @foreach($get as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->phone}} </td>
                                            <td style="    width: 10px;"><a href="{{route('single_page_address', $item->id)}}" class="btn btn-inverse-warning btn-fw">Редактирование</a> </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
