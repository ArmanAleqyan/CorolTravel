            ...
            <div class="col-12 grid-margin stretch-card" bis_skin_checked="1">
                <div class="card" bis_skin_checked="1">
                    <div class="card-body" bis_skin_checked="1">
                        ...
                        <form id="myForm" action="{{route('create_tour_operator')}}" method="post" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group" bis_skin_checked="1">
                                <label for="exampleInputName1">Имя</label>
                                <input  style="color: #e2e8f0"  required type="text" class="form-control" id="exampleInputName1"  name="name" value="{{ old('name') }}">
                            </div>
                            <div class="form-group" bis_skin_checked="1">
                                <label for="exampleInputName1">Email</label>
                                <input  style="color: #e2e8f0"  required type="text" class="form-control" id="exampleInputName1"  name="email" value="{{ old('email') }}">
                                @if($errors->has('email'))
                            ...
                            <div class="form-group" bis_skin_checked="1">
                                ...
                                <input  style="color: #e2e8f0"  required type="text" class="form-control" id="exampleInputName1"  name="password" value="">
                            </div>
                            ...
                            <div class="form-group" bis_skin_checked="1">
                                ...
                                <select style="color: white" name="address_id" class="form-control" id="exampleSelectGender">
                                    @foreach($get_work_address as $city)
                                        @if(old('address_id') && $city->id == old('address_id'))
