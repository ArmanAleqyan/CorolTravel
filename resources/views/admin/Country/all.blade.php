                    ...
                    <div class="card" bis_skin_checked="1">
                        <div class="card-body" bis_skin_checked="1">
                            <div style="display: flex; justify-content: space-between">
                                ...
                                <div>
                                    <form action="{{route('create_country')}}" method="post">
                                        @csrf
                                    <div class="form-group" bis_skin_checked="1">
                                        <div class="input-group" bis_skin_checked="1">
                                            <input style="color: white" name="name" type="text" class="form-control" placeholder="Новая страна" aria-label="Новая страна" aria-describedby="basic-addon2">
...
{{--                                                <br>--}}
                                                <a href="{{route('delete_country', $item->id)}}" class="btn btn-inverse-danger btn-fw">Удалить</a>
                                            </td>
