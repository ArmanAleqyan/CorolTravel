...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Lato:300,700|Montserrat:300,400,500,600,700|Source+Code+Pro&display=swap"
          rel="stylesheet">
    <script src="https://cdn.tiny.cloud/1/0rt25rv9jwzdnat56e9phi3bbnmcmxis23keq02k5p5rgmrn/tinymce/5/tinymce.min.js"></script>
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                    ...
                    <a class=" sidebar-brand brand-logo" style="color: white; text-decoration: none;" href="{{route('HomePage')}}">
                        <h3 style="color: #2f5687 !important">Coral Travel</h3>
                    </a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('all_tourss')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                            <span class="menu-title">Туры</span>
                        </a>
                    </li>
{{--                    <li class="nav-item menu-items">--}}
{{--                        <a class="nav-link" href="{{route('all_hotels')}}">--}}
{{--              <span class="menu-icon">--}}
{{--                <i class="mdi mdi-speedometer"></i>--}}
{{--              </span>--}}
{{--                            <span class="menu-title">Отели</span>--}}
{{--                        </a>--}}
{{--                    </li>--}}

                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('all_news')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                    ...
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('all_address')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                            <span class="menu-title">Контакты офисов</span>
                        </a>
                    </li>


                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('get_tour_operators')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                    ...
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('all_tours_country')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                    ...
                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('all_goroda_vileta')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                            <span class="menu-title">Города Вылета</span>
                        </a>
                    </li>

                    <li class="nav-item menu-items">
                        <a class="nav-link" href="{{route('info_o_nas')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
                            <span class="menu-title">Страница О нас</span>
                        </a>
                    </li>
                                        <li class="nav-item menu-items">
                                            <a class="nav-link" href="{{route('all_faqs')}}">
                                  <span class="menu-icon">
                                    <i class="mdi mdi-speedometer"></i>
                                  </span>
                                                <span class="menu-title">Страница Еще</span>
                                            </a>
                                        </li>
...
{{--                                <li class="nav-item"> <a href="" class="nav-link" >Для Туров</a></li>--}}
{{--                                <li class="nav-item"> <a href="" class="nav-link" >Для </a></li>--}}
{{--                            </ul>--}}
{{--                        </div>--}}
{{--                    </li>--}}
