            ...
            <div class="col-12 grid-margin stretch-card" bis_skin_checked="1">
                <div class="card" bis_skin_checked="1">
                    <div class="card-body" bis_skin_checked="1">
                        ...
                        <form id="myForm" action="{{route('create_news')}}" method="post" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group" bis_skin_checked="1">
                                ...
                                <textarea  style="height:500px; color: #e2e8f0"   type="text" class="form-control" id="exampleInputName1"  name="description"></textarea>
                            </div>
